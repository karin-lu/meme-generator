"Add a readme.txt (or any other document) that lists used third-party content (e.g. graphics, icons, etc.). Libraries listed in npm’s package.json do not have to be listed here again."
